...
png("C:/Users/aeraf/Documents/GitHub/ExData_Plotting1/plot4.png", width = 480,
    height = 480, units = "px")
par(mfrow = c(2,2))
plot(cleanData$Date_Time, cleanData$Global_active_power, type = "line",
     ...
     xlab = "",
     main = "")
plot(cleanData$Date_Time, cleanData$Voltage, type = "line",
     ylab = "Voltage",
     xlab = "datetime",
     main = "")
...
plot(cleanData$Date_Time, cleanData$Global_reactive_power, type = "line",
